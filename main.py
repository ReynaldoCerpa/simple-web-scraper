...
def get_info(driver):
    ...
    num_reviews = sanitized_num_reviews.replace(' ', '')
    return raw_business_name, int(num_reviews)
...
def extract_reviews(driver, num_reviews):
    ...
    while len(reviews) < num_reviews:
        ...
        print(offset, len(review_containers))
        ...
        scrollable_div = driver.find_element(By.CLASS_NAME, 'review-dialog-list')
